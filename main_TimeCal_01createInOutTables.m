...
%% I do not need to read MRI data right now
...
%% Output
Ns = 5000; % number of performed simulations

folderPath = 'AliThormbusModel_calibration_40s\\5000_postProcesssing';
...
save('RawOutput_25Jan22_5000sim.mat','-v7.3')
