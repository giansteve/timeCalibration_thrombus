...
for sim = 1:size(X,1)
    ...
    new_name = sprintf('bfsX%d/',sim); % new name of folder
    copyfile('0_0_1_xuPimpleFoamThrombusBFSSA/',new_name) % make the new simulation folder
