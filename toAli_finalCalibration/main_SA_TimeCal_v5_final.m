...
% load WS
load('TimeCal_WS_finalCalibration_withCopula.mat')
%% Input
% 02/03/2022
% ----------------------------------------------
% | Parameter | par1     | par2    | type      |
% ----------------------------------------------
% | Dc        | -16.0796 | 0.7507  | LogNormal |
% | gamma     | 1.0780   | 0.2795  | Laplace   |
% ----------------------------------------------
% | Copula    |          |         | Pair      |
% ----------------------------------------------
% 24/02/2022
...
exp_design_var = uq_getSample(PosteriorMarginal,Ns,'sobol');
